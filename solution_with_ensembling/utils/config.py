...
change the height width fields for resizing during the ensemble process
'''
import yaml
...
def _get_default_config():
    ...
    # dataset
    c.data = edict()
    c.data.name = 'IddDataset'
    c.data.num_classes = 8
    c.data.sample_submission_path = 'dataset/submission.csv'
    c.data.test_dir = 'dataset/test'
    c.data.train_df_path = 'dataset/train.csv'
    c.data.train_dir = 'dataset/train'
    c.data.params = edict()
    c.data.height = 227
    c.data.width = 320
    ...
    c.transforms.train.Resize.height = 227
    c.transforms.train.Resize.width = 320
    ...
    c.transforms.train.RandomCrop.height = 227
    c.transforms.train.RandomCrop.width = 320
    ...
    c.transforms.test.Resize.height = 227
    c.transforms.test.Resize.width = 320
    ...
    c.transforms.test.RandomCrop.height = 227
    c.transforms.test.RandomCrop.width = 320
...
''' recursively copy the source configuration'''
